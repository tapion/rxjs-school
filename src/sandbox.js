...
import { mapTo, scan, takeWhile, switchMap, startWith, materialize, dematerialize } from 'rxjs/operators';
...
export default () => {
    ...
    countdown$.subscribe(updateDisplay, null, () => console.log('Completado'));
